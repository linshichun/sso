...
//import win.scolia.cloud.sso.bean.input.UserInput;
//import win.scolia.cloud.sso.bean.output.UserOutput;
...
//    @CheckEntry
//    public ResponseEntity addUser(@RequestBody @Validated(UserInput.Register.class) UserInput entry, BindingResult bindingResult) {
//        try {
...
//                                                 @RequestBody @Validated(UserInput.UpdatePassword.class) UserInput entry, BindingResult bindingResult) {
//        try {
...
//    public ResponseEntity<UserOutput> getUser(@PathVariable("userName") String userName) {
...
//            return ResponseEntity.notFound().build();
//        }
//        Set<String> roles = roleCommonService.getUserRolesByUserName(userSafely.getUserName());
//        Set<String> permissions = new HashSet<>();
//        for (String roleName : roles) {
//            permissions.addAll(permissionService.getPermissionsByRoleName(roleName));
//        }
//        UserOutput vo = new UserOutput(userSafely, roles, permissions);
//        if (LOGGER.isInfoEnabled()) {
...
//    @CheckEntry
//    public ResponseEntity<Object> addRoleToUser(@PathVariable("userName") String userName, @RequestBody @Valid RoleInputDTO entry, BindingResult bindingResult) {
//        String roleName = entry.getRoleName();
//        try {
//            roleCommonService.addRoleToUser(userName, roleName);
//            if (LOGGER.isInfoEnabled()) {
...
//        try {
//            roleCommonService.romeUserRole(userName, roleName);
//            if (LOGGER.isInfoEnabled()) {
